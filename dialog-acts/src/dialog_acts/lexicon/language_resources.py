YES_WORDS_NON_NEGATABLE = r"\b(yes|yep|yup|yay|yey|sure|yeah|i want it|that's what I said|affirmative|yessir)\b"
...
YES_WORDS_NEGATABLE_LHS = r'\b(right|okay|ok|true|correct|what I said)\b'
"""
These yes words are negatable, and license a negation occurring
